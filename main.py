...
def test(update, context):
    ...
    conn.execute("CREATE TABLE authorized_users (user_id bigint PRIMARY KEY NOT NULL, created_at datetime default now(), updated_at datetime default now(), lock_version int default 0;")
